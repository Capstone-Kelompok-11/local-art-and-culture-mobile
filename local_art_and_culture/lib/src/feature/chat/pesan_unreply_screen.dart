...
class PesanUnreplyScreen extends StatelessWidget {
  const PesanUnreplyScreen({Key? key}) : super(key: key);
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => PesanSemuaScreen(),
                      ),
                    );
                  },
                  child: Column(
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => PesanUnseenScreen(),
                      ),
                    );
                  },
                  child: Column(
